...
public class Canvas implements ActionListener
{
	...
	//i hand drew every button except for settings my hand hurts
	...
	{
		//image labels
		title = new JLabel(new ImageIcon("canvastext.png"));
		title.setBounds(150,130,500,160);
		
		startBackg = new JLabel(new ImageIcon("watercolorsplash.png"));
		startBackg.setBounds(0,-10,800,700);
		
		greyOverlay = new JLabel(new ImageIcon("overlay.png"));
		greyOverlay.setBounds(0,0,800,700);
		greyOverlay.setVisible(false);
		
		greyOverlayCanvas = new JLabel(new ImageIcon("overlay.png"));
	...
	public void buttons()
	{
		...
		openSettings = new JButton(new ImageIcon("settings.png"));
		...
		exit = new JButton(new ImageIcon("exitbackshmovinout.png"));
		...
		//settings buttons
		hideSettings = new JButton(new ImageIcon("ximage.png"));
		...
		toggleSound.setFont(new Font("Garamond", Font.PLAIN, 25));
		...
		toggleDisplay.setFont(new Font("Garamond", Font.PLAIN, 25));
		...
		//instruc button
		hideInstruc = new JButton(new ImageIcon("ximage.png"));
		...
		//canvas buttons
		openMenu = new JButton(new ImageIcon("menubutton.png"));
		...
		//menu buttons
		hideMenu = new JButton(new ImageIcon("hideMenu.png"));
		...
		escapeCanvas = new JButton(new ImageIcon("exitbackshmovinout.png"));
		...
		resetCanvas = new JButton(new ImageIcon("refresh.png"));
		...
		random = new ImageIcon("random.png");
		custom = new ImageIcon("custom.png");
		...
		//shape menu buttons
		circle = new JButton(new ImageIcon("circleIcon.png"));
		circle.setBounds(25,70,45,45);
		circle.setBorderPainted(true);
		circle.addActionListener(this);
		circle.setVisible(false);
		
		triangle = new JButton(new ImageIcon("triangleIcon.png"));
		triangle.setBounds(109,70,45,45);
		triangle.setBorderPainted(true);
		triangle.addActionListener(this);
		triangle.setVisible(false);
		
		square = new JButton(new ImageIcon("squareIcon.png"));
